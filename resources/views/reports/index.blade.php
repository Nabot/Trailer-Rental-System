    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- My Commission -->
                <a href="{{ route('reports.commission') }}" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 hover:shadow-md transition">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold">My Commission</h3>
                            <p class="text-sm text-gray-600">Leads assigned to you and 10% of converted booking value</p>
                        </div>
                    </div>
                </a>
