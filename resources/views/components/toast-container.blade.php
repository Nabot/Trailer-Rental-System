    ...
    <template x-for="(toast, index) in toasts" :key="index">
        <div 
            ...
            :class="{
                ...
                'bg-yellow-50 dark:bg-yellow-900 border border-yellow-200 dark:border-yellow-700': toast.type === 'warning',
            ...
            <div class="p-4">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                        ...
                        <svg x-show="toast.type === 'info' || !toast.type" class="h-5 w-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="ml-4 flex-shrink-0 flex">
                        <button 
                            ...
                            :class="{
                                ...
                                'text-blue-400 hover:text-blue-500 focus:ring-blue-500': toast.type === 'info' || !toast.type
                            }">
