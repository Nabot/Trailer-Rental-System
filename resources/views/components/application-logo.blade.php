@if(file_exists(public_path('images/ironaxle-logo.png')))
    <img src="{{ asset('images/ironaxle-logo.png') }}" alt="IronAxle Rentals" {{ $attributes->merge(['class' => 'h-9 w-auto']) }} />
@elseif(file_exists(public_path('images/ironaxle-logo.svg')))
    <img src="{{ asset('images/ironaxle-logo.svg') }}" alt="IronAxle Rentals" {{ $attributes->merge(['class' => 'h-9 w-auto']) }} />
@else
